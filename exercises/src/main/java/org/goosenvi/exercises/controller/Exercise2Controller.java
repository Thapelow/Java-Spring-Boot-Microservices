...
public class Exercise2Controller {
    ...
    public void logPOSTnote(@RequestBody NotePlain note){
        log.info("Exercise 2, Post mapping received. Note information: " + note.getNoteInformation());
    }

    @PutMapping("exercise2/note")
    public void logPUTnote(@RequestBody NotePlain note){
        log.info("Exercise 2, Put mapping received. Note information: " + note.getNoteInformation());
    }
}
